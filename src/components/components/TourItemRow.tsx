    ...
    <div >
      {
        tourItemsView.map((item, index) => {
          ...
          <div className="col col-2" style={{fontWeight: 'bold', color: 'rgb(44, 48, 53)'}}>{item.destination}</div>
          <div className="col col-2" style={{fontWeight: 'bold', color: 'rgb(44, 48, 53)'}}>{item.departureDate}</div>
          <div className="col col-1" style={{fontWeight: 'bold', color: 'rgb(44, 48, 53)'}}>{item.status}</div>
          <div className="col col-2 ps-5" style={{fontWeight: 'bold', color: 'rgb(44, 48, 53)'}}>{item.availability}/{item.totalAvailability}</div>
