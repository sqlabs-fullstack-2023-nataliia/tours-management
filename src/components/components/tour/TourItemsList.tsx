...
const TourItemsList = ({tourItemsView}: Props) => {
    ...
    <div >
      {
        tourItemsView.map((item, index) => {
          ...
          <div className="col col-1 d-none d-xl-block" style={{color: 'rgb(44, 48, 53)'}}>
              <img data-bs-toggle="modal" data-bs-target={`#${item.id}`} src={item.image || tourData.noImageFile} rel='image' style={{ width: '100%', height: '50px' }}/>
          </div>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="" style={{color: 'rgb(44, 48, 53)'}}>
                    <img src={item.image || tourData.noImageFile} rel='image' style={{ width: '100%', height: '300px' }}/>
                  </div>
                </div>
              </div>
            </div>
